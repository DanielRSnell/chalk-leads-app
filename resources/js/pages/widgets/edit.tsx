...
const steps = [
    ...
    { id: 5, title: 'Review', subtitle: 'Ready to save changes?' },
];

export default function EditWidget({ widget }: EditWidgetProps) {
    ...
    const handleSubmit = () => {
        put(route('widgets.update', { widget: widget.id }), {
            onSuccess: () => {
                    ...
                    >
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-gray-600">Update your widget configuration and settings</p>
                                ...
                                {currentStep === 5 && (
                                    ...
                                    >
                                        ...
                                        <div className="text-center space-y-4">
                                            ...
                                            <p className="text-gray-600">Your widget configuration will be updated with these new settings.</p>
                                        </div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
